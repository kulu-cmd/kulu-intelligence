...
const tiles: Tile[] = [
  {
    label: "Learn",
    title: "Seminars",
    body: "Focused, in-person sessions that bring teams up to speed on practical AI.",
    meta: "60 — 120 min",
    href: "/learn",
    surface: "dawn",
    image: "/seminars.png",
  },
  {
    label: "Implement",
    title: "Workflows",
    body: "We automate your manual and tedious processes. More time to enjoy the things that matter.",
    meta: "From R8,500",
    href: "/implement",
    surface: "indigo",
    image: "/workflows.png",
  },
  {
    label: "Testimonials",
    title: "Testimonies",
    body: "Don't take our word, hear from our happy clients.",
    meta: "37 engagements",
    href: "/case-studies",
    surface: "coral",
  ...
  },
  {
    label: "Why Kulu",
    title: "Why Kulu",
    body: "We take pride in educating and building. Put your trust into us and we put our skills into your business.",
